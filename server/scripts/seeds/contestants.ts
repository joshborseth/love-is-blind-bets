...
// import { db } from '../../db';
// import { femaleContestants } from '../../db/schema';
// import { Resource } from 'sst';
import { promises as fs } from 'fs';
// import { map } from 'radash';
// import { transformNamesToFileNames } from '../../utils/transformNamesToFileNames/transformNamesToFileNames';
...
export const handler = async () => {
	...
	// 		description: c.desc,
	// 		imageUrl: c.img
	// 	})) satisfies Array<Omit<typeof maleContestants.$inferInsert, 'headShotUrl'>>;
	...
	// 		description: c.desc,
	// 		imageUrl: c.img
	// 	})) satisfies Array<Omit<typeof femaleContestants.$inferInsert, 'headShotUrl'>>;

	// const headShotImg = await fs.readFile('alexandra.jpg');
	const tryAgain = await fs.readFile('server/scripts/seeds/alexandra.jpg');
